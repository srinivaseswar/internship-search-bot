...
function Brand() {
  return <Link href="/" data-testid="link-brand" className="flex items-center gap-3"><div className="grid h-9 w-9 place-items-center rounded-xl bg-sidebar-primary text-sidebar-primary-foreground"><Sparkles size={18} fill="currentColor" /></div><div><div className="font-display text-[15px] font-bold tracking-tight">Internship<span className="text-sidebar-primary">/</span>CC</div><div className="font-mono-app text-[8px] uppercase tracking-[.2em] text-sidebar-foreground/40">command center</div></div></Link>;
}
